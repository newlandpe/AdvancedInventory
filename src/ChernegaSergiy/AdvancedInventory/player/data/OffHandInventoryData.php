...
class OffHandInventoryData implements SavableData {
    ...
    public function load(Player $player): void {
        $this->inventoryContents = $player->getOffHandInventory()->getContents(true);
    }

    public function applyTo(Player $player): void {
        $player->getOffHandInventory()->setContents($this->inventoryContents);
    }
